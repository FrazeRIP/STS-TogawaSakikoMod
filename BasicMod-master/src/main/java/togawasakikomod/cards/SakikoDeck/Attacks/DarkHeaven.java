...
import togawasakikomod.Actions.StealStrengthAction;
...
//月光奏鸣曲
public class DarkHeaven extends BaseCard {
    public static final String ID = makeID(DarkHeaven.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new StealStrengthAction(magicNumber,m,p));
    }
}