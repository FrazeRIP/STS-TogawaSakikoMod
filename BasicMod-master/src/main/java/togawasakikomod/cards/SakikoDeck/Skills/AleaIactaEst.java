...
import togawasakikomod.Actions.UpgradeAllCardInDrawPileAction;
import togawasakikomod.cards.BaseCard;
import togawasakikomod.character.TogawaSakiko;
import togawasakikomod.util.CardStats;

public class AleaIactaEst extends BaseCard {
    public static final String ID = makeID(AleaIactaEst.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(upgraded){
            addToBot(new UpgradeAllCardInDrawPileAction());
        }
