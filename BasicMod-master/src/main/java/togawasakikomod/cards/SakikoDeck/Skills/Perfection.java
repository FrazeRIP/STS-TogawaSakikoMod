...
import togawasakikomod.Actions.PerfectionAction;
...
public class Perfection extends BaseCard {
    public static final String ID = makeID(Perfection.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new PlayAudioAction(Perfection.class.getSimpleName()));

        addToBot(new PerfectionAction());
    }
}