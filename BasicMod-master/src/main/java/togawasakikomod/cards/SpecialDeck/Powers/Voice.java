...
public class Voice extends BaseCard {
    public static final String ID = makeID(Voice.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        for(int i = 0; i<magicNumber;i++){
            addToBot(new ApplyPowerAction(p,p,new MantraPower(p,2),2));
        }
    }
}