...
public class BlackKeys extends BaseCard {
    public static final String ID = makeID(BlackKeys.class.getSimpleName());
    ...
    public  void onChoseThisOption(){
        ...
        if(m!=null){
            addToBot(new ApplyPowerAction(m,p,new DazzlingPower(m,magicNumber)));
        }
    }
