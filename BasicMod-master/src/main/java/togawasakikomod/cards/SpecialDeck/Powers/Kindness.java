...
import togawasakikomod.Actions.AddBackLostPowersAction;
import togawasakikomod.cards.BaseCard;
import togawasakikomod.character.TogawaSakiko;
import togawasakikomod.util.CardStats;

public class Kindness extends BaseCard {
    public static final String ID = makeID(Kindness.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new AddBackLostPowersAction(true));}
    }