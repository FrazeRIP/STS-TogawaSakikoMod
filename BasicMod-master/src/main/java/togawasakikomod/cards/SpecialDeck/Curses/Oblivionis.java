...
public class Oblivionis extends BaseCard {
    public static final String ID = makeID(Oblivionis.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {  if (this.dontTriggerOnUseCard) {
        //this.addToTop(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new OblivionisPower(AbstractDungeon.player, 1,true), 1));
        }
    }
}