...
public class EnemyDivinityParticleEffect extends AbstractGameEffect {
    ...
    public EnemyDivinityParticleEffect(AbstractCreature owner) {
        ...
        if (owner != null) {
            this.x = owner.hb.cX + MathUtils.random(-owner.hb.width / 2.0F - 50.0F * Settings.scale, owner.hb.width / 2.0F + 50.0F * Settings.scale);
            this.y = owner.hb.cY + MathUtils.random(-owner.hb.height / 2.0F + 10.0F * Settings.scale, owner.hb.height / 2.0F - 20.0F * Settings.scale);
        }
