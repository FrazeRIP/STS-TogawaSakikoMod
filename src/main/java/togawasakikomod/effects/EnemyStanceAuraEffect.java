...
public class EnemyStanceAuraEffect extends AbstractGameEffect {
    ...
    public EnemyStanceAuraEffect(String stanceId, AbstractCreature owner) {
        this.owner = owner;
        ...
        if(owner != null) {
            this.x = owner.hb.cX + MathUtils.random(-owner.hb.width / 16.0F, owner.hb.width / 16.0F);
            this.y = owner.hb.cY + MathUtils.random(-owner.hb.height / 16.0F, owner.hb.height / 12.0F);
        }
