...
public class Timoris extends BaseCard {
    public static final String ID = makeID(Timoris.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {  if (this.dontTriggerOnUseCard) {
        this.addToTop(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new TimorisPower(AbstractDungeon.player, 1, false), 1));
        }
    }
}