...
public class Endurance extends BaseCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new PlayAudioAction(Endurance.class.getSimpleName()));
        this.addToBot(new ApplyPowerAction(p, p, new EndurancePower(AbstractDungeon.player, magicNumber), magicNumber));
    }
}