...
//月光奏鸣曲
public class SilentFarewell extends BaseCard {
    public static final String ID = makeID(SilentFarewell.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        for(AbstractCreature c : AbstractDungeon.getCurrRoom().monsters.monsters){
            addToBot(new ApplyPowerAction(c,p,new VulnerablePower(c,magicNumber,false)));
        }
    }
}