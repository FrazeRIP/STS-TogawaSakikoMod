...
import togawasakikomod.powers.buffs.OurSongPower;
import togawasakikomod.util.CardStats;

public class OurSong extends BaseCard {
    public static final String ID = makeID(OurSong.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new PlayAudioAction(OurSong.class.getSimpleName()));
        addToBot(new ApplyPowerAction(p,p,new OurSongPower(p,1),1));
    }
}