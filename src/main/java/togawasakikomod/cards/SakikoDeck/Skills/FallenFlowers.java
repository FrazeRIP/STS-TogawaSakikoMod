...
public class FallenFlowers extends BaseCard {
    public static final String ID = makeID(FallenFlowers.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new PlayAudioAction(FallenFlowers.class.getSimpleName()));
