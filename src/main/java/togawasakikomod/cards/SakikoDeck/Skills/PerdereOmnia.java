...
import togawasakikomod.powers.buffs.PerdereOmniaPower;
import togawasakikomod.util.CardStats;

public class PerdereOmnia extends BaseCard {
    public static final String ID = makeID(PerdereOmnia.class.getSimpleName());
