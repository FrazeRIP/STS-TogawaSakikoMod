...
public class AreTheseLyrics extends BaseCard {
    ...
    public AreTheseLyrics() {
        super(ID, info); //Pass the required information to the BaseCard constructor.
        cardsToPreview = (AbstractCard) new Melody();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new PlayAudioAction(AreTheseLyrics.class.getSimpleName()));

        addToBot(new AreTheseLyricsAction(this.upgraded));
    }
}