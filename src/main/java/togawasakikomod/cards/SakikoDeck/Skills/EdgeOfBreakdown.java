...
public class EdgeOfBreakdown extends BaseCard {
    public static final String ID = makeID(EdgeOfBreakdown.class.getSimpleName());
    ...
    private static final int SHIELD = 16;
    private static final int UPG_SHIELD = 4;
