...
import togawasakikomod.powers.buffs.GodsCreationPower;
import togawasakikomod.util.CardStats;

//月光奏鸣曲
public class Angles extends BaseCard {
    public static final String ID = makeID(Angles.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new GodsCreationPower(p,1)));
        addToBot(new ApplyPowerAction(m,p,new GodsCreationPower(m,1)));
    }
}