...
import togawasakikomod.cards.SpecialDeck.Curses.Amoris;
import togawasakikomod.character.TogawaSakiko;
import togawasakikomod.util.CardStats;

//月光奏鸣曲
public class SymbolIIAir extends BaseCard {
    public static final String ID = makeID(SymbolIIAir.class.getSimpleName());
