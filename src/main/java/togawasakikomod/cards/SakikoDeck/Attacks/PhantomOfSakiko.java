...
//月光奏鸣曲
public class PhantomOfSakiko extends BaseCard {
    public static final String ID = makeID(PhantomOfSakiko.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new DamageAction(m, new DamageInfo(p, damage, DamageInfo.DamageType.NORMAL), AbstractGameAction.AttackEffect.BLUNT_HEAVY));
        addToBot(new DamageAction(m, new DamageInfo(p, damage, DamageInfo.DamageType.NORMAL), AbstractGameAction.AttackEffect.BLUNT_HEAVY));
        AbstractCard card = new Radiance();
        if(upgraded){
            card.upgrade();
        }
        ...
        //TogawaSakiko.TryPlayAudio(PhantomOfSakiko.class.getSimpleName());
    }
}