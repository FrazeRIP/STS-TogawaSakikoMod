...
//月光奏鸣曲
public class Kao extends BaseCard {
    public static final String ID = makeID(Kao.class.getSimpleName());
    ...
    public void applyPowers() {
        super.applyPowers();
        this.baseDamage = DAMAGE +this.misc*MAGIC_NUMBER;
        if(upgraded){this.baseDamage += UPG_DAMAGE;}
