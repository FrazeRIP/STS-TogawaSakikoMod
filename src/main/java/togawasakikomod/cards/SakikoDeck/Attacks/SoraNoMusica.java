...
import togawasakikomod.Actions.SoraNoMusicaAction;
...
//月光奏鸣曲
public class SoraNoMusica extends BaseCard {
    public static final String ID = makeID(SoraNoMusica.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new SoraNoMusicaAction(magicNumber,true));
    }
}