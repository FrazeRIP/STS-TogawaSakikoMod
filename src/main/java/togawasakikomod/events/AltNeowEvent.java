...
import togawasakikomod.rewards.AltNeowReward;

import static togawasakikomod.TogawaSakikoMod.makeID;

public class AltNeowEvent extends AbstractEvent {
    private static final Logger logger = LogManager.getLogger(AltNeowEvent.class.getName());
    ...
    private ArrayList<AltNeowReward> rewards = new ArrayList<>();
    ...
    public void update() {
        ...
        while(var4.hasNext()) {
            AltNeowReward r = (AltNeowReward)var4.next();
            r.update();
        }
    ...
    static {
        characterStrings = CardCrawlGame.languagePack.getCharacterString(makeID(AltNeowEvent.class.getSimpleName()));
