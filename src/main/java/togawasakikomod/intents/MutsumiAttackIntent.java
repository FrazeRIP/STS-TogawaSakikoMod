package togawasakikomod.intents;
...
public class MutsumiAttackIntent extends CustomIntent {

    //That's just how I do IDs, you might do it differently.
    public static final String ID = TogawaSakikoMod.makeID(MutsumiAttackIntent.class.getSimpleName());
     ...
     */
    public MutsumiAttackIntent() {
        super(CustomEnumPatch.TOGAWASAKIKO_MUTSUMI_ATTACK,
                TEXT[0],
                TextureLoader.getLargeIntentTextureString(MutsumiAttackIntent.class.getSimpleName()),
                TextureLoader.getIntentTextureString(MutsumiAttackIntent.class.getSimpleName())//These are just the paths to my images.
        );
    }
