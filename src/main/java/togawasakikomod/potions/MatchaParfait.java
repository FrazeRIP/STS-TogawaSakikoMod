...
public class MatchaParfait extends BasePotion {
    ...
    private static final String containerTexPath = potionPath(MatchaParfait.class.getSimpleName()+"/container.png");
    private static final String outlineTexPath = potionPath(MatchaParfait.class.getSimpleName()+"/outline.png");
